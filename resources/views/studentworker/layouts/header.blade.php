...
<div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" id="sidebar-wrapper" role="navigation">
            <ul class="nav sidebar-nav">
                ...
                @if (Auth::guard('studentworkers')->user())
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-fw fa-plus"></i> {{ Auth::guard('studentworkers')->user()->name }} <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="#">View Profile</a></li>
                    <li><a href="#">Edit Profile</a></li>
                    <li><a href="#">Settings</a></li>
                    <li>
                        <a href="{{ url('/studentworker/logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                            Logout
                        </a>

                        <form id="logout-form" action="{{ url('/studentworker/logout') }}" method="POST" style="display: none;">
                            {{ csrf_field() }}
                        </form>
                    </li>
                  </ul>
                ...
                @else
                <li>
                    <a href="{{ url('/studentworker/login') }}"><i class="fa fa-fw fa-file-o"></i> Login</a>
                </li>
                <li>
                    <a href="{{ url('/studentworker/register') }}"><i class="fa fa-fw fa-file-o"></i> Register</a>
                </li>
                @endif
            </ul>
        </nav>
